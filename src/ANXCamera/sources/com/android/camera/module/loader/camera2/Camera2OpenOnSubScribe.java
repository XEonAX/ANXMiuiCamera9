...
public class Camera2OpenOnSubScribe implements SingleOnSubscribe<Camera2Result>, SurfaceCreatedCallback {
    ...
    public void subscribe(SingleEmitter<Camera2Result> e) throws Exception {
        this.mCamera2Result = null;
        this.mSingleEmitter = e;
        openCamera();
    }
