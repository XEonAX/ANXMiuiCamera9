...
public class HorizontalListView extends AdapterView<ListAdapter> {
            ...
            for (int i = 0; i < HorizontalListView.this.getChildCount(); i++) {
                ...
                if (isEventWithinView(e, child)) {
                    ...
                    if (HorizontalListView.this.mOnItemSingleTapDowned != null) {
                        HorizontalListView.this.mOnItemSingleTapDowned.onSingleTapDown(HorizontalListView.this, child, dataIndex, HorizontalListView.this.mAdapter.getItemId(dataIndex));
                    }
                    return true;
                }
            }
    ...
    public void setOnItemSingleTapDownListener(OnSingleTapDownListener listener) {
        this.mOnItemSingleTapDowned = listener;
    }
    ...
    protected synchronized void onLayout(boolean r9, int r10, int r11, int r12, int r13) {
        ...
        r8 = this;
        monitor-enter(r8);
        super.onLayout(r9, r10, r11, r12, r13);	 Catch:{ all -> 0x00c2 }
        r6 = r8.mAdapter;	 Catch:{ all -> 0x00c2 }
    ...
    L_0x000a:
        r1 = 0;
        r6 = r8.mDataChanged;	 Catch:{ all -> 0x00c2 }
        if (r6 == 0) goto L_0x001d;
    L_0x000f:
        r4 = r8.mCurrentX;	 Catch:{ all -> 0x00c2 }
        r8.initView();	 Catch:{ all -> 0x00c2 }
        r8.removeAllViewsInLayout();	 Catch:{ all -> 0x00c2 }
        r8.mNextX = r4;	 Catch:{ all -> 0x00c2 }
        r6 = 0;
        r8.mDataChanged = r6;	 Catch:{ all -> 0x00c2 }
        r1 = 1;
    L_0x001d:
        r6 = r8.mScroller;	 Catch:{ all -> 0x00c2 }
        r6 = r6.computeScrollOffset();	 Catch:{ all -> 0x00c2 }
        if (r6 == 0) goto L_0x002d;
    L_0x0025:
        r6 = r8.mScroller;	 Catch:{ all -> 0x00c2 }
        r5 = r6.getCurrX();	 Catch:{ all -> 0x00c2 }
        r8.mNextX = r5;	 Catch:{ all -> 0x00c2 }
    L_0x002d:
        r6 = r8.mNextX;	 Catch:{ all -> 0x00c2 }
        if (r6 > 0) goto L_0x003a;
    L_0x0031:
        r6 = 0;
        r8.mNextX = r6;	 Catch:{ all -> 0x00c2 }
        r6 = r8.mScroller;	 Catch:{ all -> 0x00c2 }
        r7 = 1;
        r6.forceFinished(r7);	 Catch:{ all -> 0x00c2 }
    L_0x003a:
        r6 = r8.mNextX;	 Catch:{ all -> 0x00c2 }
        r7 = r8.mMaxX;	 Catch:{ all -> 0x00c2 }
        if (r6 < r7) goto L_0x004a;
    L_0x0040:
        r6 = r8.mMaxX;	 Catch:{ all -> 0x00c2 }
        r8.mNextX = r6;	 Catch:{ all -> 0x00c2 }
        r6 = r8.mScroller;	 Catch:{ all -> 0x00c2 }
        r7 = 1;
        r6.forceFinished(r7);	 Catch:{ all -> 0x00c2 }
    L_0x004a:
        r6 = r8.mCurrentX;	 Catch:{ all -> 0x00c2 }
        r7 = r8.mNextX;	 Catch:{ all -> 0x00c2 }
        r3 = r6 - r7;
        r6 = r8.mNextX;	 Catch:{ all -> 0x00c2 }
        r8.mCurrentX = r6;	 Catch:{ all -> 0x00c2 }
        r8.removeNonVisibleItems(r3);	 Catch:{ all -> 0x00c2 }
        r8.fillList(r3);	 Catch:{ all -> 0x00c2 }
        r8.positionItems(r3);	 Catch:{ all -> 0x00c2 }
        r6 = r8.mScroller;	 Catch:{ all -> 0x00c2 }
        r6 = r6.isFinished();	 Catch:{ all -> 0x00c2 }
        if (r6 == 0) goto L_0x0067;
    L_0x0065:
        if (r1 == 0) goto L_0x0071;
    L_0x0067:
        r6 = new com.android.camera.ui.HorizontalListView$3;	 Catch:{ all -> 0x00c2 }
        r6.<init>();	 Catch:{ all -> 0x00c2 }
        r8.post(r6);	 Catch:{ all -> 0x00c2 }
    L_0x006f:
        monitor-exit(r8);
        return;
    L_0x0071:
        r8.loadItems();	 Catch:{ all -> 0x00c2 }
        r6 = r8.mScroller;	 Catch:{ all -> 0x00c2 }
        r6 = r6.isFinished();	 Catch:{ all -> 0x00c2 }
        if (r6 == 0) goto L_0x006f;
    L_0x007c:
        r6 = r8.mTouchDown;	 Catch:{ all -> 0x00c2 }
        r6 = r6 ^ 1;
        if (r6 == 0) goto L_0x006f;
    L_0x0082:
        r6 = 0;
        r8.mIsScrollingPerformed = r6;	 Catch:{ all -> 0x00c2 }
        r6 = r8.mSelectCenter;	 Catch:{ all -> 0x00c2 }
        if (r6 == 0) goto L_0x0091;
    L_0x0089:
        r6 = new com.android.camera.ui.HorizontalListView$4;	 Catch:{ all -> 0x00c2 }
        r6.<init>();	 Catch:{ all -> 0x00c2 }
        r8.post(r6);	 Catch:{ all -> 0x00c2 }
    L_0x0091:
        r6 = r8.mSelectViewIndex;	 Catch:{ all -> 0x00c2 }
        r7 = r8.mPreviousSelectViewIndex;	 Catch:{ all -> 0x00c2 }
        if (r6 == r7) goto L_0x006f;
    L_0x0097:
        r6 = r8.mSelectViewIndex;	 Catch:{ all -> 0x00c2 }
        r7 = r8.mLeftViewIndex;	 Catch:{ all -> 0x00c2 }
        if (r6 <= r7) goto L_0x00bd;
    L_0x009d:
        r6 = r8.mSelectViewIndex;	 Catch:{ all -> 0x00c2 }
        r7 = r8.mRightViewIndex;	 Catch:{ all -> 0x00c2 }
        if (r6 > r7) goto L_0x00bd;
    L_0x00a3:
        r6 = r8.mSelectViewIndex;	 Catch:{ all -> 0x00c2 }
        r2 = r8.toDataIndex(r6);	 Catch:{ all -> 0x00c2 }
        r6 = r8.mSelectViewIndex;	 Catch:{ all -> 0x00c2 }
        r7 = r8.mLeftViewIndex;	 Catch:{ all -> 0x00c2 }
        r6 = r6 - r7;
        r6 = r6 + -1;
        r0 = r8.getChildAt(r6);	 Catch:{ all -> 0x00c2 }
        r6 = r8.mAdapter;	 Catch:{ all -> 0x00c2 }
        r6 = r6.getItemId(r2);	 Catch:{ all -> 0x00c2 }
        r8.notifyItemSelect(r0, r2, r6);	 Catch:{ all -> 0x00c2 }
    L_0x00bd:
        r6 = r8.mSelectViewIndex;	 Catch:{ all -> 0x00c2 }
        r8.mPreviousSelectViewIndex = r6;	 Catch:{ all -> 0x00c2 }
        goto L_0x006f;
    L_0x00c2:
        r6 = move-exception;
        monitor-exit(r8);
    ...
    private void positionItems(int dx) {
        if (getChildCount() > 0) {
            ...
            for (int i = 0; i < getChildCount(); i++) {
                ...
                if (this.mSelectCenter && left < center && left + childWidth > center && (oldCenter ^ 1) != 0) {
    ...
    private void notifyItemSelect(View view, int index, long id) {
        if (view != null) {
            ...
            } else if (index == toDataIndex(this.mSelectViewIndex)) {
                if (this.mLastSelectImageListItem != null) {
                    this.mLastSelectImageListItem.setActivated(false);
                }
                this.mLastSelectImageListItem = view;
