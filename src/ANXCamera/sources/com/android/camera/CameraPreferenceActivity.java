...
public class CameraPreferenceActivity extends BasePreferenceActivity {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (System.getInt(getContentResolver(), "volumekey_wake_screen", 0) == 1) {
            ...
            return false;
        } else if ((newValue.equals(getString(R.string.pref_camera_snap_value_take_picture)) || newValue.equals(getString(R.string.pref_camera_snap_value_take_movie))) && "public_transportation_shortcuts".equals(Secure.getString(getContentResolver(), "key_long_press_volume_down"))) {
            ...
            CameraStatUtil.trackPreferenceChange("pref_camera_snap_key", newValue);
            return true;
        }
    }
            ...
            OnClickListener listener = new OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    if (which == -1) {
                        ...
                        CameraStatUtil.trackPreferenceChange("pref_camera_snap_key", snapItem);
