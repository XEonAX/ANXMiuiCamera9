...
public class DefaultItemAnimator extends ItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (removalsPending || (movesPending ^ 1) == 0 || (additionsPending ^ 1) == 0 || (changesPending ^ 1) == 0) {
            ...
            if (additionsPending) {
                ...
                if (removalsPending) {
                    ViewCompat.postOnAnimationDelayed(((ViewHolder) additions.get(0)).itemView, adder, getRemoveDuration());
                } else {
                    adder.run();
                }
            }
    ...
    public boolean animateAdd(ViewHolder holder) {
        resetAnimation(holder);
        ViewCompat.setTranslationX(holder.itemView, (float) (this.mAleft ? holder.itemView.getWidth() : -holder.itemView.getWidth()));
    ...
    private void animateAddImpl(final ViewHolder holder) {
        ...
        animation.translationX(0.0f).setDuration(getAddDuration()).setListener(new VpaListenerAdapter() {
            public void onAnimationStart(View view) {
    ...
    private void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            final ViewPropertyAnimatorCompat oldViewAlpha = ViewCompat.animate(view).setDuration(0);
            oldViewAlpha.alpha(0.0f).setListener(new VpaListenerAdapter() {
                public void onAnimationStart(View view) {
                }

                public void onAnimationEnd(View view) {
                    oldViewAlpha.setListener(null);
                    ViewCompat.setAlpha(view, 1.0f);
                    DefaultItemAnimator.this.dispatchChangeFinished(changeInfo.oldHolder, true);
                    DefaultItemAnimator.this.dispatchFinishedWhenDone();
                }
