...
public class GLCanvasState {
    ...
    private class CanvasStateConfig {
        ...
        public CanvasStateConfig(float[] modelMatrix, float[] texMatrix, float alpha, float blendAlpha) {
            System.arraycopy(modelMatrix, 0, this.mModelMatrix, 0, 16);
            System.arraycopy(texMatrix, 0, this.mTexMatrix, 0, 16);
            this.mAlpha = alpha;
    ...
    public void popState() {
        if (!this.mCanvasStateStack.isEmpty()) {
            CanvasStateConfig matrixObject = (CanvasStateConfig) this.mCanvasStateStack.pop();
