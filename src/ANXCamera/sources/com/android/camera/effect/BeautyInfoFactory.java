...
public class BeautyInfoFactory {
    ...
    private static final /* synthetic */ int[] f2-com-miui-filtersdk-filter-helper-FilterTypeSwitchesValues = null;

    /* renamed from: -getcom-miui-filtersdk-filter-helper-FilterTypeSwitchesValues */
    private static /* synthetic */ int[] m2-getcom-miui-filtersdk-filter-helper-FilterTypeSwitchesValues() {
        if (f2-com-miui-filtersdk-filter-helper-FilterTypeSwitchesValues != null) {
            return f2-com-miui-filtersdk-filter-helper-FilterTypeSwitchesValues;
        }
        ...
        f2-com-miui-filtersdk-filter-helper-FilterTypeSwitchesValues = iArr;
        return iArr;
    }
    ...
    public static ArrayList<FilterInfo> initBeautyFilterInfo() {
        ...
        for (FilterType type : FilterFactory.getFiltersByScene(FilterScene.BEAUTY)) {
            switch (m2-getcom-miui-filtersdk-filter-helper-FilterTypeSwitchesValues()[type.ordinal()]) {
                case 12:
                    order = 50;
