...
public class GroupShot {
    ...
    public int initialize(int maxImageNum, int maxFaceNum, int width, int height, int max_width, int max_height) {
        ...
        Log.v(TAG, String.format(Locale.ENGLISH, "initialize imageNum=%d, width=%d, height=%d, mStart=%b, mWidth=%d, mHeight=%d, mMaxImageNum=%d", new Object[]{Integer.valueOf(maxImageNum), Integer.valueOf(width), Integer.valueOf(height), Boolean.valueOf(this.mStart), Integer.valueOf(this.mWidth), Integer.valueOf(this.mHeight), Integer.valueOf(this.mMaxImageNum)}));
