...
class ExifOutputStream extends FilterOutputStream {
                    ...
                    switch (this.mState) {
                        ...
                        case 1:
                            ...
                            if (this.mBuffer.position() >= 4) {
                                ...
                                if (marker == (short) -31) {
                                    this.mByteToSkip = (this.mBuffer.getShort() & SupportMenu.USER_MASK) - 2;
                                    this.mState = 2;
                                    ...
                                    this.out.write(this.mBuffer.array(), 0, 4);
                                    this.mByteToCopy = (this.mBuffer.getShort() & SupportMenu.USER_MASK) - 2;
                                }
                                this.mBuffer.rewind();
                                break;
                            }
    ...
    private void writeExifData() throws IOException {
        if (this.mExifData != null) {
            ...
            if (exifSize + 8 > SupportMenu.USER_MASK) {
    ...
    private ArrayList<ExifTag> stripNullValueTags(ExifData data) {
        ...
        if (data.getAllTags() != null) {
            for (ExifTag t : data.getAllTags()) {
                if (t.getValue() == null && (ExifInterface.isOffsetTag(t.getTagId()) ^ 1) != 0) {
