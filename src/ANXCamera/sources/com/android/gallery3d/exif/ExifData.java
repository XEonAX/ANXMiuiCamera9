...
class ExifData {
    ...
    public boolean equals(Object obj) {
        ...
        if (data.mByteOrder != this.mByteOrder || data.mStripBytes.size() != this.mStripBytes.size() || (Arrays.equals(data.mThumbnail, this.mThumbnail) ^ 1) != 0) {
            return false;
        }
        int i;
        ...
        for (i = 0; i < 5; i++) {
            ...
            if (ifd1 != ifd2 && ifd1 != null && (ifd1.equals(ifd2) ^ 1) != 0) {
                return false;
            }
        }
        return true;
