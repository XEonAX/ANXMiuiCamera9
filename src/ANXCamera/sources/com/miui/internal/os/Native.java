...
public class Native {
    ...
    public static Method getMethod(java.lang.reflect.Method method) {
        ...
        String signature = ReflectUtils.getSignature(method.getParameterTypes(), method.getReturnType());
        if ((method.getModifiers() & 8) != 0) {
            z = true;
        }
        return getMethod(declaringClass, name, name2, signature, z, method);
    }
    ...
    public static Field getField(java.lang.reflect.Field field) {
        ...
        String signature = ReflectUtils.getSignature(field.getType());
        if ((field.getModifiers() & 8) != 0) {
            z = true;
        }
        return getField(declaringClass, name, name2, signature, z, field);
    }
}
