    ...
    public static abstract class Callback {
        ...
        public long getAnimationDuration(RecyclerView recyclerView, int animationType, float animateDx, float animateDy) {
            ...
            if (itemAnimator != null) {
                return animationType != 8 ? itemAnimator.getRemoveDuration() : itemAnimator.getMoveDuration();
            }
        ...
        public int interpolateOutOfBoundsScroll(RecyclerView recyclerView, int viewSize, int viewSizeOutOfBounds, int totalSize, long msSinceStartScroll) {
            ...
            if ((msSinceStartScroll <= DRAG_SCROLL_ACCELERATION_LIMIT_TIME_MS ? 1 : null) == null) {
                timeRatio = 1.0f;
            } else {
        ...
        if (selected != this.mSelected || actionState != this.mActionState) {
            ...
            if (this.mSelected != null) {
                ...
                if (prevSelected.itemView.getParent() == null) {
                    ...
                    int animationType;
                    final int swipeDir = prevActionState != 2 ? swipeIfNecessary(prevSelected) : 0;
                    releaseVelocityTracker();
                    switch (swipeDir) {
                        case 1:
                        case 2:
