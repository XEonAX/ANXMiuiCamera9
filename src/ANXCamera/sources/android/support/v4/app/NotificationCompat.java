...
public class NotificationCompat {
    ...
    public static class Action extends android.support.v4.app.NotificationCompatBase.Action {
        ...
        public static final class Builder {
            ...
            public Action build() {
                return new Action(this.mIcon, this.mTitle, this.mIntent, this.mExtras, this.mRemoteInputs == null ? null : (RemoteInput[]) this.mRemoteInputs.toArray(new RemoteInput[this.mRemoteInputs.size()]));
            }
        }
