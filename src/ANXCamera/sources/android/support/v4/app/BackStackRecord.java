...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, Runnable {
    ...
    static final boolean SUPPORTS_TRANSITIONS = (VERSION.SDK_INT < 21 ? SUPPORTS_TRANSITIONS : true);
    ...
    public void run() {
        ...
        int transitionStyle = state == null ? this.mTransitionStyle : 0;
        int transition = state == null ? this.mTransition : 0;
        Op op = this.mHead;
        while (op != null) {
            int enterAnim = state == null ? op.enterAnim : 0;
            int exitAnim = state == null ? op.exitAnim : 0;
            Fragment f;
            switch (op.cmd) {
                case 1:
                    f = op.fragment;
    ...
    public TransitionState popFromBackStack(boolean doStateMove, TransitionState state, SparseArray<Fragment> firstOutFragments, SparseArray<Fragment> lastInFragments) {
        ...
        Op op = this.mTail;
        while (op != null) {
            int popEnterAnim = state == null ? op.popEnterAnim : 0;
            int popExitAnim = state == null ? op.popExitAnim : 0;
            Fragment f;
            switch (op.cmd) {
                case 1:
                    f = op.fragment;
    ...
    public boolean isEmpty() {
        return this.mNumOp != 0 ? SUPPORTS_TRANSITIONS : true;
    }
    ...
    private static Object getEnterTransition(Fragment inFragment, boolean isBack) {
        ...
        return FragmentTransitionCompat21.cloneTransition(!isBack ? inFragment.getEnterTransition() : inFragment.getReenterTransition());
    }
    ...
    private static Object getExitTransition(Fragment outFragment, boolean isBack) {
        ...
        return FragmentTransitionCompat21.cloneTransition(!isBack ? outFragment.getExitTransition() : outFragment.getReturnTransition());
    }
    ...
    private static Object getSharedElementTransition(Fragment inFragment, Fragment outFragment, boolean isBack) {
        ...
        return FragmentTransitionCompat21.wrapSharedElementTransition(!isBack ? inFragment.getSharedElementEnterTransition() : outFragment.getSharedElementReturnTransition());
    }
    ...
    private boolean configureTransitions(int containerId, TransitionState state, boolean isBack, SparseArray<Fragment> firstOutFragments, SparseArray<Fragment> lastInFragments) {
        ...
        if (sharedElementTransition != null) {
            ...
            if (namedViews.isEmpty()) {
                ...
                SharedElementCallback callback = !isBack ? inFragment.mEnterTransitionCallback : outFragment.mEnterTransitionCallback;
                if (callback != null) {
        ...
        if (inFragment != null) {
            allowOverlap = !isBack ? inFragment.getAllowEnterTransitionOverlap() : inFragment.getAllowReturnTransitionOverlap();
        }
    ...
    private void callSharedElementEnd(TransitionState state, Fragment inFragment, Fragment outFragment, boolean isBack, ArrayMap<String, View> namedViews) {
        SharedElementCallback sharedElementCallback = !isBack ? inFragment.mEnterTransitionCallback : outFragment.mEnterTransitionCallback;
    ...
    private void setBackNameOverrides(TransitionState state, ArrayMap<String, View> namedViews, boolean isEnd) {
        ...
        if (this.mSharedElementTargetNames != null) {
            count = this.mSharedElementTargetNames.size();
        }
