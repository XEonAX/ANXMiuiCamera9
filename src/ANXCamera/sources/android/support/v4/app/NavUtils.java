...
public class NavUtils {
    ...
    static class NavUtilsImplBase implements NavUtilsImpl {
        ...
        public Intent getParentActivityIntent(Activity activity) {
            ...
            try {
                return NavUtils.getParentActivityName(activity, target) != null ? new Intent().setComponent(target) : IntentCompat.makeMainActivity(target);
    ...
    public static Intent getParentActivityIntent(Context context, Class<?> sourceActivityClass) throws NameNotFoundException {
        ...
        return getParentActivityName(context, target) != null ? new Intent().setComponent(target) : IntentCompat.makeMainActivity(target);
    }
