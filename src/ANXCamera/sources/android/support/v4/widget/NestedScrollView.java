...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent, NestedScrollingChild {
            ...
            if (event.getAction() == 0) {
                switch (event.getKeyCode()) {
                    ...
                    case MotionEventCompat.AXIS_RUDDER /*20*/:
                        ...
                        break;
                    case 62:
                        pageScroll(!event.isShiftPressed() ? TransportMediator.KEYCODE_MEDIA_RECORD : 33);
                        break;
                }
            }
            return handled;
    ...
    protected boolean onRequestFocusInDescendants(int direction, Rect previouslyFocusedRect) {
        ...
        View nextFocus = previouslyFocusedRect != null ? FocusFinder.getInstance().findNextFocusFromRect(this, previouslyFocusedRect, direction) : FocusFinder.getInstance().findNextFocus(this, null, direction);
    ...
    private static boolean isViewDescendantOf(View child, View parent) {
        ...
        if (!((theParent instanceof ViewGroup) && isViewDescendantOf(theParent, parent))) {
            z = false;
        }
        return z;
    }
