...
public class ViewDragHelper {
    ...
    private int computeSettleDuration(View child, int dx, int dy, int xvel, int yvel) {
        ...
        return (int) ((((float) computeAxisDuration(dx, xvel, this.mCallback.getViewHorizontalDragRange(child))) * (xvel == 0 ? ((float) absDx) / ((float) addedDistance) : ((float) absXVel) / ((float) addedVel))) + (((float) computeAxisDuration(dy, yvel, this.mCallback.getViewVerticalDragRange(child))) * (yvel == 0 ? ((float) absDy) / ((float) addedDistance) : ((float) absYVel) / ((float) addedVel))));
    }
    ...
    protected boolean canScroll(View v, boolean checkV, int dx, int dy, int x, int y) {
        ...
        if (checkV && (ViewCompat.canScrollHorizontally(v, -dx) || ViewCompat.canScrollVertically(v, -dy))) {
            z = true;
        } else {
            z = false;
        }
    ...
    /* JADX WARNING: Missing block: B:54:0x0232, code:
            if (r11 == r13) goto L_0x0228;
     */
    ...
    /* JADX WARNING: Missing block: B:44:0x0249, code:
    ...
    L_0x021d:
        ...
        r19 = r0;
        r0 = r19;
        if (r15 != r0) goto L_0x0216;
    L_0x0227:
        r13 = -1;
        r14 = android.support.v4.view.MotionEventCompat.getPointerCount(r22);
        r8 = 0;
    L_0x022d:
        if (r8 < r14) goto L_0x0239;
    L_0x022f:
        r19 = -1;
        r0 = r19;
