...
public class SlidingPaneLayout extends ViewGroup {
    ...
    private class DragHelperCallback extends Callback {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if (SlidingPaneLayout.this.isLayoutRtlSupport()) {
                ...
                if (obj != null || (xvel == 0.0f && SlidingPaneLayout.this.mSlideOffset > 0.5f)) {
    ...
    void updateObscuredViewsVisibility(View panel) {
        ...
        int startBound = !isLayoutRtl ? getPaddingLeft() : getWidth() - getPaddingRight();
            ...
            for (i = 0; i < childCount; i++) {
                ...
                if (child.getVisibility() != 8) {
                    ...
                    if (child.getVisibility() != 8) {
                        ...
                        int measuredWidth = !skippedFirstPass ? child.getMeasuredWidth() : 0;
    ...
    private void onPanelDragged(int newLeft) {
        if (this.mSlideableView != null) {
            ...
            this.mSlideOffset = ((float) ((!isLayoutRtl ? newLeft : (getWidth() - newLeft) - this.mSlideableView.getWidth()) - ((!isLayoutRtl ? getPaddingLeft() : getPaddingRight()) + (!isLayoutRtl ? lp.leftMargin : lp.rightMargin)))) / ((float) this.mSlideRange);
            if (this.mParallaxBy != 0) {
                parallaxOtherViews(this.mSlideOffset);
            }
            if (lp.dimWhenOffset) {
    ...
    private void parallaxOtherViews(float slideOffset) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (v != this.mSlideableView) {
                ...
                if (dimViews) {
                    dimChildView(v, !isLayoutRtl ? 1.0f - this.mParallaxOffset : this.mParallaxOffset - 1.0f, this.mCoveredFadeColor);
                }
            }
        }
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        ss.isOpen = !isSlideable() ? this.mPreservedOpenState : isOpen();
        return ss;
    }
