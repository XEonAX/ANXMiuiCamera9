            ...
            switch (action & 255) {
                ...
                case 1:
                    ...
                    if (this.mIsDoubleTapping) {
                        ...
                        if ((Math.abs(velocityY) > ((float) this.mMinimumFlingVelocity) ? 1 : null) != null || Math.abs(velocityX) > ((float) this.mMinimumFlingVelocity)) {
                ...
                case 2:
                    ...
                    if ((Math.abs(scrollX) >= 1.0f ? 1 : null) == null && Math.abs(scrollY) < 1.0f) {
                        return false;
                    }
                    handled = this.mListener.onScroll(this.mCurrentDownEvent, ev, scrollX, scrollY);
                    this.mLastFocusX = focusX;
