...
public class ViewPager extends ViewGroup {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:122:0x03fe  */
    ...
    L_0x00ec:
        return;
    L_0x00ed:
        r27 = r30.getResources();	 Catch:{ NotFoundException -> 0x0159 }
        r28 = r30.getId();	 Catch:{ NotFoundException -> 0x0159 }
        r24 = r27.getResourceName(r28);	 Catch:{ NotFoundException -> 0x0159 }
    L_0x00f9:
    ...
    private void enableLayers(boolean enable) {
        int childCount = getChildCount();
        for (int i = 0; i < childCount; i++) {
            ViewCompat.setLayerType(getChildAt(i), !enable ? 0 : 2, null);
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action & 255) {
            ...
            case 2:
                ...
                if (this.mIsBeingDragged) {
                    needsInvalidate = performDrag(MotionEventCompat.getX(ev, MotionEventCompat.findPointerIndex(ev, this.mActivePointerId))) | 0;
                    break;
                }
                break;
            case 3:
