...
class ViewCompatBase {
    ...
    static ColorStateList getBackgroundTintList(View view) {
        return !(view instanceof TintableBackgroundView) ? null : ((TintableBackgroundView) view).getSupportBackgroundTintList();
    }
    ...
    static Mode getBackgroundTintMode(View view) {
        return !(view instanceof TintableBackgroundView) ? null : ((TintableBackgroundView) view).getSupportBackgroundTintMode();
    }
