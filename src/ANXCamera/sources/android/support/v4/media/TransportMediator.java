...
public class TransportMediator extends TransportController {
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer callbacks) {
        ...
        this.mKeyEventCallback = new Callback() {
            public boolean onKeyDown(int keyCode, KeyEvent event) {
                return !TransportMediator.isMediaKey(keyCode) ? false : TransportMediator.this.mCallbacks.onMediaButtonDown(keyCode, event);
            }
            ...
            public boolean onKeyUp(int keyCode, KeyEvent event) {
                return !TransportMediator.isMediaKey(keyCode) ? false : TransportMediator.this.mCallbacks.onMediaButtonUp(keyCode, event);
            }
    ...
    public Object getRemoteControlClient() {
        return this.mController == null ? null : this.mController.getRemoteControlClient();
    }
