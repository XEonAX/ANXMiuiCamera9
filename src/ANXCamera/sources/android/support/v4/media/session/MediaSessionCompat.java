        ...
        public void setMetadata(MediaMetadataCompat metadata) {
            ...
            if (this.mIsActive) {
                ...
                if (VERSION.SDK_INT >= 19) {
                    ...
                    MediaSessionCompatApi19.setMetadata(obj, bundle, this.mState != null ? this.mState.getActions() : 0);
                } else if (VERSION.SDK_INT >= 14) {
                    obj = this.mRccObj;
                    if (metadata != null) {
                        bundle = metadata.getBundle();
