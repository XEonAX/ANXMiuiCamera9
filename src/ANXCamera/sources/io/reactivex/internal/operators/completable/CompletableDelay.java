...
public final class CompletableDelay extends Completable {
    ...
    final class Delay implements CompletableObserver {
        ...
        public void onError(Throwable e) {
            this.set.add(CompletableDelay.this.scheduler.scheduleDirect(new OnError(e), !CompletableDelay.this.delayError ? 0 : CompletableDelay.this.delay, CompletableDelay.this.unit));
        }
