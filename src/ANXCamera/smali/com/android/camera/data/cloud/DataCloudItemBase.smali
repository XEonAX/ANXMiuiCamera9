...
.method public getCloudBooleanDefault(Ljava/lang/String;Z)Z
    ...
    .param p2, "localDefault"    # Z

    .prologue
    .line 34
    iget-boolean v1, p0, Lcom/android/camera/data/cloud/DataCloudItemBase;->mReady:Z
    ...
    .line 37
    :cond_0
    iget-object v1, p0, Lcom/android/camera/data/cloud/DataCloudItemBase;->mValues:Landroid/support/v4/util/SimpleArrayMap;
    ...
    .end local p2    # "localDefault":Z
    :goto_0
    return p2

    .restart local p2    # "localDefault":Z
    :cond_2
...
.method public getCloudFloatDefault(Ljava/lang/String;F)F
    ...
    .end local p2    # "localDefault":F
    :goto_0
    return p2

    .restart local p2    # "localDefault":F
    :cond_2
...
.method public getCloudIntDefault(Ljava/lang/String;I)I
    ...
    .end local p2    # "localDefault":I
    :goto_0
    return p2

    .restart local p2    # "localDefault":I
    :cond_2
...
.method public getCloudLongDefault(Ljava/lang/String;J)J
    ...
    .end local p2    # "localDefault":J
    :goto_0
    return-wide p2

    .restart local p2    # "localDefault":J
    :cond_2
...
.method public getCloudStringDefault(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    .locals 2
    .param p1, "key"    # Ljava/lang/String;
    .param p2, "localDefault"    # Ljava/lang/String;
    ...
    .end local p2    # "localDefault":Ljava/lang/String;
    :goto_0
    return-object p2

    .restart local p2    # "localDefault":Ljava/lang/String;
    :cond_2
    move-object p2, v0
